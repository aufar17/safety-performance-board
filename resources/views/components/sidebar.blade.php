<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <x-navlink href="{{ route('index') }}" :active="request()->is('/') " icon="fa-house">Mapping Potential Area
            </x-navlink>
            <li class="
            nav-item mt-3">
            ...
            <x-navlink href="{{ route('accident') }}" :active="request()->is('accident')" icon="fa-car-burst">Update
                Accident
            </x-navlink>
            <x-navlink href="{{ route('pica-admin') }}" :active="request()->is('pica-admin')" icon="fa-file-contract">
                Update PICA Accident
            </x-navlink>
            <x-navlink href="{{ route('issue-admin') }}" :active="request()->is('issue-admin')" icon="fa-file">Update
                Safety Issue
            </x-navlink>
            <li class="
            nav-item mt-3">
